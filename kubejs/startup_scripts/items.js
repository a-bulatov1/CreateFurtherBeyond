...
// Textures must use the 'furtherbeyond' namespace to avoid a bug involving kubejs loading textures from resource packs.
...
StartupEvents.registry("item", event => {
    event.create("alchemical_laser").parentModel("furtherbeyond:item/alchemical_laser").displayName("Alchemical Laser (Ponder Entry)").unstackable()

    let types = ["Certus", "Fluix"]
    types.forEach(e => {
        let id = e.toLowerCase()
        event.create(id + "_crystal_seed").texture("furtherbeyond:item/crystal_seed_" + id).displayName(e + " Quartz Seed")
        event.create("growing_" + id + "_seed","create:sequenced_assembly").texture("furtherbeyond:item/crystal_seed_" + id).displayName(e + " Quartz Seed")
        event.create("tiny_" + id + "_crystal").texture("furtherbeyond:item/crystal_seed_" + id + "2").displayName("Tiny " + e + " Quartz Crystal")
        event.create("growing_tiny_" + id + "_crystal","create:sequenced_assembly").texture("furtherbeyond:item/crystal_seed_" + id + "2").displayName("Tiny " + e + " Quartz Crystal")
        event.create("small_" + id + "_crystal").texture("furtherbeyond:item/crystal_seed_" + id + "3").displayName("Small " + e + " Quartz Crystal")
        event.create("growing_small_" + id + "_crystal","create:sequenced_assembly").texture("furtherbeyond:item/crystal_seed_" + id + "3").displayName("Small " + e + " Quartz Crystal")
    });

    let processors = ["Calculation", "Logic", "Engineering"]
    processors.forEach(name => {
        let e = name.toLowerCase()
        event.create("incomplete_" + e + "_processor","create:sequenced_assembly").texture("furtherbeyond:item/incomplete_" + e + "_processor").displayName("Incomplete " + name + " Processor")
    })
    ...
    let number = (name) => {
        ...
        event.create(id).texture("furtherbeyond:item/" + id).glow(true).displayName(name)
    }
    ...
    event.create("radiant_coil").glow(true).texture("furtherbeyond:item/radiant_coil").displayName("Radiant Induction Coil")
    event.create("radiant_sheet").glow(true).texture("furtherbeyond:item/radiant_sheet").displayName("Radiant Sheet")
    ...
    for (let i = 0; i < slime_types.length; i++) {
        ...
        event.create(`${id}_slimy_fern_leaf`)
            ...
            .texture("furtherbeyond:item/slimy_fern_leaf")
            .displayName("Slimy Fern Leaf")
        event.create(`${id}_slime_fern_paste`)
            .color(0, slime_colours[i])
            .texture("furtherbeyond:item/ground_slimy_fern")
            .displayName("Slimy Fern Blend")
    }

    // Misc / Integration
    event.create("pipe_module_utility").texture("furtherbeyond:item/pipe_module_utility").displayName("Utility Pipe Module")
    event.create("pipe_module_tier_1").texture("furtherbeyond:item/pipe_module_tier_1").displayName("Brass Pipe Module")
    event.create("pipe_module_tier_2").texture("furtherbeyond:item/pipe_module_tier_2").displayName("Invar Pipe Module")
    event.create("pipe_module_tier_3").texture("furtherbeyond:item/pipe_module_tier_3").displayName("Enderium Pipe Module")

    event.create("circuit_scrap").texture("furtherbeyond:item/circuit_scrap").displayName("Circuit Scrap")
    // event.create('charged_calculator').texture("furtherbeyond:item/charged_calculator").displayName('Calculator').maxDamage(64)
    event.create("missingno").texture("furtherbeyond:item/missingno").displayName("∄")
    event.create("zinc_dust").texture("furtherbeyond:item/zinc_dust").displayName("Zinc Dust").tag("forge:dusts/zinc").tag("forge:dusts")
    // event.create('creosote_pellet').texture("furtherbeyond:item/creosote_pellet").displayName('Creosote Pellet')
    event.create("sand_ball").texture("furtherbeyond:item/sand_ball").displayName("Ball of Sand").unstackable()
    event.create("rough_sand").texture("furtherbeyond:item/rough_sand").displayName("Sand Chunks")
    event.create("purified_sand").texture("furtherbeyond:item/purified_sand").displayName("Purified Sand")
    event.create("silicon_compound").texture("furtherbeyond:item/silicon_compound").displayName("Silicon Compound")
    event.create("incomplete_coke_chunk","create:sequenced_assembly").texture("furtherbeyond:item/incomplete_coke_chunk").displayName("Cut Coke")
    event.create("coke_chunk").texture("furtherbeyond:item/coke_chunk").displayName("Coke Chunks")
    // event.create('smoke_mote').texture("furtherbeyond:item/smoke_mote").displayName('Tiny Smoke Cloud')

    event.create("matter_plastics").texture("furtherbeyond:item/matter_plastics").displayName("Matter Plastics")
    event.create("nickel_compound").texture("furtherbeyond:item/nickel_compound").displayName("Nickel Compound").unstackable()
    event.create("invar_compound","create:sequenced_assembly").texture("furtherbeyond:item/invar_compound").displayName("Unprocessed Invar Ingot")
    event.create("dye_entangled_singularity").texture("furtherbeyond:item/dye_entangled_singularity").unstackable().displayName("Chromatic Singularity")

    event.create("strainer_filter").texture("waterstrainer:items/strainer_survivalist").displayName("Strainer Filter").maxDamage(384)
    event.create("chromatic_resonator").texture("furtherbeyond:item/chromatic_resonator").displayName("Chromatic Resonator").maxDamage(512)
    event.create("flash_drive").texture("furtherbeyond:item/boot_medium").displayName("Flash Drive").maxDamage(512)

    event.create("thermal_cast").texture("furtherbeyond:item/thermal_cast").displayName("Thermal Cast").unstackable()
    event.create("three_cast").texture("furtherbeyond:item/three_cast").displayName("Integer Cast (3)").unstackable()
    event.create("eight_cast").texture("furtherbeyond:item/eight_cast").displayName("Integer Cast (8)").unstackable()
    event.create("plus_cast").texture("furtherbeyond:item/plus_cast").displayName("Operator Cast (+)").unstackable()
    event.create("minus_cast").texture("furtherbeyond:item/minus_cast").displayName("Operator Cast (-)").unstackable()
    event.create("multiply_cast").texture("furtherbeyond:item/multiply_cast").displayName("Operator Cast (x)").unstackable()
    event.create("divide_cast").texture("furtherbeyond:item/divide_cast").displayName("Operator Cast (/)").unstackable()
    event.create("attachment_base").texture("furtherbeyond:item/attachment_base").displayName("Attachment Base")
    event.create("silver_coin").texture("furtherbeyond:item/silver_coin").displayName("Silver Coin Stack Icon")
    event.create("gold_coin").texture("furtherbeyond:item/gold_coin").displayName("Gold Coin Stack Icon")

    event.create("mystic_pottery_sherd").texture("furtherbeyond:item/mystic_pottery_sherd").displayName("Mystic Pottery Sherd").tag("minecraft:decorated_pot_ingredients").tag("minecraft:decorated_pot_sherds")
    event.create("cozy_pottery_sherd").texture("furtherbeyond:item/cozy_pottery_sherd").displayName("Cozy Pottery Sherd").tag("minecraft:decorated_pot_ingredients").tag("minecraft:decorated_pot_sherds")
    event.create("circuit_pottery_sherd").texture("furtherbeyond:item/circuit_pottery_sherd").displayName("Circuit Pottery Sherd").tag("minecraft:decorated_pot_ingredients").tag("minecraft:decorated_pot_sherds")
})
...
StartupEvents.registry("block", event => {
    ...
    // event.create("ponder_laser_lamp").model("furtherbeyond:block/ponder_laser_lamp").notSolid().renderType("translucent").displayName("Laser Lamp (For Ponder)")
    // event.create("ponder_laser_lamp_on").model("furtherbeyond:block/ponder_laser_lamp_on").notSolid().lightLevel(15).renderType("translucent").displayName("Laser Lamp (For Ponder)")
    event.create("navigation_computer", "cardinal").soundType("metal").tagBlock("mineable/pickaxe").hardness(3.0).requiresTool(true).displayName("Navigation Computer")
    event.create("lander_deployer", "cardinal").soundType("metal").tagBlock("mineable/pickaxe").hardness(3.0).requiresTool(true).displayName("Lander Deployer")
    ...
    for (let i = 0; i < 15; i++)
        substrateblock(0x394867, 0x14274E, `failed_alchemy_${i}`, "Mundane Alchemic Blend", "furtherbeyond:block/mundane_substrate")
    ...
    let createSubstrate = (c1, c2, id, name, model, ingredient, outputItem) => {
        ...
        let substrate = substrateblock(c1, c2, `substrate_${id}`, name, "furtherbeyond:block/" + model)
    ...
    substrateblock(0xb200ed, 0xff66cc, "substrate_chaos", "Chaos Catalyst", "furtherbeyond:block/chaos_catalyst")
        .item(item => item.rarity("rare"))

    substrateblock(0x474449, 0x967DA0, "substrate_silicon", "Silicon Reagent", "furtherbeyond:block/substrate")
        .item(item => item.rarity("rare"))

    substrateblock(0x9FADB4, 0xBECCD2, "substrate_silver", "Silver Reagent", "furtherbeyond:block/substrate")
        .item(item=>item.rarity("rare"))

    acceleratorBlock(0xFFBC5E, "accellerator_glowstone", "Glowstone Accelerator", "furtherbeyond:block/accellerator")

    acceleratorBlock(0xAA0F01, "accellerator_redstone", "Redstone Accelerator", "furtherbeyond:block/accellerator")
    */
})

StartupEvents.registry("fluid", event => {
    let colors = [0xCBE827, 0xAEE827, 0x68E827, 0x27E86E, 0x27E8B1, 0x27DEE8, 0x27B5E8, 0x2798E8, 0x2778E8, 0x2748E8]
    event.create("raw_logic").displayName("Liquified Logic (Unprocessed)").stillTexture("furtherbeyond:fluid/number_still").flowingTexture("furtherbeyond:fluid/number_flow").tint(0xE7FFCB)
    for (let i = 0; i < 10; i++)
        event.create("number_" + i).displayName(`Liquified Logic (${i})`).stillTexture("furtherbeyond:fluid/number_still").flowingTexture("furtherbeyond:fluid/number_flow").tint(colors[i])
    event.create("matrix").displayName("Liquified Computation Matrix").stillTexture("furtherbeyond:fluid/matrix_still").flowingTexture("furtherbeyond:fluid/matrix_flow")//.bucketColor(colors[0])
    event.create("fine_sand").displayName("Fine Sand").stillTexture("furtherbeyond:fluid/fine_sand_still").flowingTexture("furtherbeyond:fluid/fine_sand_flow")//.bucketColor(0xE3DBB0)
    ...
    event.create("volatile_sky_solution").displayName("Volatile Sky Solution").stillTexture("tconstruct:fluid/molten/compat_alloy/refined_obsidian/still").flowingTexture("tconstruct:fluid/molten/compat_alloy/refined_obsidian/flowing").tint(0x8feebf)//.bucketColor(0x1A1123)
    event.create("chromatic_waste").displayName("Chromatic Waste").stillTexture("tconstruct:fluid/molten/compat_alloy/enderium/still").flowingTexture("tconstruct:fluid/molten/compat_alloy/enderium/flowing").tint(0x0B3E36)
    event.create("liquid_pulp").displayName("Liquid Pulp").stillTexture("tconstruct:fluid/molten/compat_alloy/pewter/still").flowingTexture("tconstruct:fluid/molten/compat_alloy/pewter/still").tint(0xb4a498)
